# TASK-M1-006 — Create Initial ADRs
...
Create Initial ADRs as a small, independently reviewable step for Repository Foundation.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M1-repository-foundation.md`
- Recommended previous task: TASK-M1-005

## 3. In Scope

- Record Tauri 2, Rust provider logic, subscription/API separation, local-first, and PTY gate decisions.
