# TASK-M1-005 — Configure Rust Tooling
...
Configure Rust Tooling as a small, independently reviewable step for Repository Foundation.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M1-repository-foundation.md`
- Recommended previous task: TASK-M1-004

## 3. In Scope

- Document or pin Rust toolchain.
- Establish fmt, clippy, test, and check commands.
