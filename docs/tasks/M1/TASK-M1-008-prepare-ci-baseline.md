# TASK-M1-008 — Prepare CI Baseline
...
Prepare CI Baseline as a small, independently reviewable step for Repository Foundation.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M1-repository-foundation.md`
- Recommended previous task: TASK-M1-007

## 3. In Scope

- Run locked frontend checks and Rust checks.
- Avoid real provider credentials.
- Add sanitized fixture checks where feasible.
