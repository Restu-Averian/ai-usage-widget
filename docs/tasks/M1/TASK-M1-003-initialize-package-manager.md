# TASK-M1-003 — Initialize Package Manager
...
Initialize Package Manager as a small, independently reviewable step for Repository Foundation.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M1-repository-foundation.md`
- Recommended previous task: TASK-M1-002

## 3. In Scope

- Initialize pnpm package metadata and lockfile.
- Set supported Node and package-manager versions.
- Avoid multiple package-manager lockfiles.
