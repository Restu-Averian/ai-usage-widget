# TASK-M1-007 — Create Root README
...
Create Root README as a small, independently reviewable step for Repository Foundation.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M1-repository-foundation.md`
- Recommended previous task: TASK-M1-006

## 3. In Scope

- Describe project and current status.
- Link core documents and milestones.
- Document setup, verification, and task workflow.
