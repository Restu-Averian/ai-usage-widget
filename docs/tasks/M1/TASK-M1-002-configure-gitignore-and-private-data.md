# TASK-M1-002 — Configure Git Ignore and Private Data

**Milestone:** [M1 — Repository Foundation](../../milestones/M1-repository-foundation.md)  
**Status:** DONE  
**Priority:** P0  
...
Configure Git Ignore and Private Data as a small, independently reviewable step for Repository Foundation.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M1-repository-foundation.md`
- Recommended previous task: TASK-M1-001

## 3. In Scope

- Ignore .private, raw captures, environment files, local databases, and builds.
- Keep lockfiles trackable.
- Document never-commit file classes.
