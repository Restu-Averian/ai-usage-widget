# TASK-M8-002 — Build Secure API Key Flow
...
Build Secure API Key Flow as a small, independently reviewable step for API Usage.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M8-api-usage.md`
- Recommended previous task: TASK-M8-001

## 3. In Scope

- Connect masked dialog to Rust validation and native storage.
- Clear input and expose no read-back.
