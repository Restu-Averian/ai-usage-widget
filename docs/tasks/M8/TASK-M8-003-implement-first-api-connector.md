# TASK-M8-003 — Implement First API Connector

**Milestone:** [M8 — API Usage](../../milestones/M8-api-usage.md)  
**Status:** BACKLOG  
**Priority:** P2  
...
Implement First API Connector as a small, independently reviewable step for API Usage.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M8-api-usage.md`
- Recommended previous task: TASK-M8-002

## 3. In Scope

- Call first supported usage and cost endpoints from Rust with TLS, timeout, bounded response, and safe errors.
