# TASK-M8-004 — Implement API Normalization
...
Implement API Normalization as a small, independently reviewable step for API Usage.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M8-api-usage.md`
- Recommended previous task: TASK-M8-003

## 3. In Scope

- Normalize input, output, cached tokens, requests, cost, currency, period, fetched time, and unknown fields.
