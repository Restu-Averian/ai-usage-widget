# TASK-M8-001 — Define API Usage Contracts
...
Define API Usage Contracts as a small, independently reviewable step for API Usage.
...
- Define separate token, request, cost, currency, budget, period, connection, Rust, TS, and Zod types.
