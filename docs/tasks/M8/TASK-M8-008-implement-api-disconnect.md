# TASK-M8-008 — Implement API Disconnect
...
Implement API Disconnect as a small, independently reviewable step for API Usage.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M8-api-usage.md`
- Recommended previous task: TASK-M8-007

## 3. In Scope

- Delete secret, update connection metadata, and preserve history by default.
