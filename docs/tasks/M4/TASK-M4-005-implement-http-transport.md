# TASK-M4-005 — Implement HTTP Transport
...
Implement HTTP Transport as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-004

## 3. In Scope

- Create Rust HTTP client abstraction with TLS, timeouts, bounded response, and safe error mapping.
- Keep secrets inside Rust.
