# TASK-M4-011 — Implement Backend Events
...
Implement Backend Events as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-010

## 3. In Scope

- Emit typed refresh, auth, install, settings, wake, and network events.
- Never send raw output or secrets.
