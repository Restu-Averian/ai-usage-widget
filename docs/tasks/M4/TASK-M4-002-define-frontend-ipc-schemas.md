# TASK-M4-002 — Define Frontend IPC Schemas
...
Define Frontend IPC Schemas as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-001

## 3. In Scope

- Create matching TypeScript types and Zod schemas.
