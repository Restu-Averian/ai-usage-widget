# TASK-M4-004 — Implement Process Runner
...
Implement Process Runner as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-003

## 3. In Scope

- Spawn absolute executables with argument arrays.
- Enforce timeout, output limit, cancellation, and exit metadata.
- Do not expose generic IPC.
