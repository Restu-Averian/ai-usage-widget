...
Implement Data Repositories as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-006

## 3. In Scope

- Implement connection, snapshot, window, history, retention, and notification-state repositories.
