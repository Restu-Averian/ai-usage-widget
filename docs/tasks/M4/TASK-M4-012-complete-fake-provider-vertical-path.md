# TASK-M4-012 — Complete Fake Provider Vertical Path
...
Complete Fake Provider Vertical Path as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-011

## 3. In Scope

- Run fake refresh through registry, persistence, event, IPC, query invalidation, UI, restart, and error simulation.
