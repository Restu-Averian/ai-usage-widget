# TASK-M4-008 — Implement Secret Store
...
Implement Secret Store as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-007

## 3. In Scope

- Implement set, exists, internal consume, and delete.
- Use native credential store abstraction.
- Expose no secret-read IPC.
