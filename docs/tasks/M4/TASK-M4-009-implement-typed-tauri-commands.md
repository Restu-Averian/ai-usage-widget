# TASK-M4-009 — Implement Typed Tauri Commands
...
Implement Typed Tauri Commands as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-008

## 3. In Scope

- Expose narrow bootstrap, provider, connection, history, and settings commands.
- Use safe errors and minimal capabilities.
