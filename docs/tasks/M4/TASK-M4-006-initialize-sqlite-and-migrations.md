# TASK-M4-006 — Initialize SQLite and Migrations
...
Initialize SQLite and Migrations as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-005

## 3. In Scope

- Use app-data path, WAL, foreign keys, busy timeout, transactional migrations, and UTC.
