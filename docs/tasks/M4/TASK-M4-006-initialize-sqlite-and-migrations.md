# TASK-M4-006 — Initialize Latest-State SQLite Schema
...
Initialize migrations for latest snapshots, refresh metadata, connection state, settings, and executable approvals only.
