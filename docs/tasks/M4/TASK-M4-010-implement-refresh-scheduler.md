# TASK-M4-010 — Implement Refresh Scheduler
...
Implement Refresh Scheduler as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-009

## 3. In Scope

- Add per-provider single-flight, jitter, backoff, stale rules, popup-open refresh, and wake hooks.
