# TASK-M4-003 — Implement Provider Registry
...
Implement Provider Registry as a small, independently reviewable step for Core Application Layer.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M4-core-application-layer.md`
- Recommended previous task: TASK-M4-002

## 3. In Scope

- Create connector and capability interfaces.
- Register fake providers.
- Isolate provider state and failure.
