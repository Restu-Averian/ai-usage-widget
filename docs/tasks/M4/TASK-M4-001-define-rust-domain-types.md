# TASK-M4-001 — Define Rust Domain Types
...
Define Rust Domain Types as a small, independently reviewable step for Core Application Layer.
...
- Implement provider, connection, reliability, usage-window, snapshot, and error types.
- Validate percentages and serialize IPC shapes.
