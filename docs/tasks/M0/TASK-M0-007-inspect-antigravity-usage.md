# TASK-M0-007 — Inspect Antigravity Usage
...
Inspect Antigravity Usage as a small, independently reviewable step for Provider Feasibility.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M0-provider-feasibility.md`
- Recommended previous task: TASK-M0-006

## 3. In Scope

- Capture OAuth, API-key or cloud-project states when available.
- Inspect model-specific quota and exhausted states.
- Document TTY, reset, and version behavior.
