# TASK-M0-006 — Inspect Claude Usage
...
Inspect Claude Usage as a small, independently reviewable step for Provider Feasibility.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M0-provider-feasibility.md`
- Recommended previous task: TASK-M0-005

## 3. In Scope

- Distinguish subscription and API-key modes.
- Capture usage, logged-out, offline, and error behavior.
- Document session, weekly, reset, and TTY behavior.
