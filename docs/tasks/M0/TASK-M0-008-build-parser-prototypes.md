# TASK-M0-008 — Build Parser Prototypes
...
Build Parser Prototypes as a small, independently reviewable step for Provider Feasibility.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M0-provider-feasibility.md`
- Recommended previous task: TASK-M0-007

## 3. In Scope

- Normalize ANSI and line endings.
- Parse versioned sanitized fixtures into normalized spike types.
- Reject malformed or unsupported output explicitly.
