# TASK-M0-009 — Add Parser Fixture Tests
...
Add Parser Fixture Tests as a small, independently reviewable step for Provider Feasibility.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M0-provider-feasibility.md`
- Recommended previous task: TASK-M0-008

## 3. In Scope

- Add expected normalized results for every fixture.
- Cover auth, logout, offline, exhausted, and malformed states.
- Run secret checks over committed fixtures.
