# TASK-M0-005 — Inspect Codex Usage
...
Inspect Codex Usage as a small, independently reviewable step for Provider Feasibility.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M0-provider-feasibility.md`
- Recommended previous task: TASK-M0-004

## 3. In Scope

- Capture authenticated, logged-out, offline, and error behavior.
- Inspect documented status or usage interfaces.
- Document TTY, reset, and quota-window behavior.
