# TASK-M0-001 — Scaffold Spike Workspace
...
Scaffold Spike Workspace as a small, independently reviewable step for Provider Feasibility.
...
- Create spike scripts, parsers, fixtures, tests, and results directories.
- Create ignored .private raw-capture directories.
- Add spike README and safety rules.
