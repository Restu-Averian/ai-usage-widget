# TASK-M0-003 — Implement Output Redaction
...
Implement Output Redaction as a small, independently reviewable step for Provider Feasibility.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M0-provider-feasibility.md`
- Recommended previous task: TASK-M0-002

## 3. In Scope

- Redact emails, user paths, tokens, API keys, and session identifiers.
- Write sanitized output separately from raw captures.
- Fail closed when possible secrets remain.
