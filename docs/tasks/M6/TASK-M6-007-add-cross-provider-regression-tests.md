# TASK-M6-007 — Add Cross-Provider Regression Tests
...
Add Cross-Provider Regression Tests as a small, independently reviewable step for Second Provider Integration.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M6-second-provider-integration.md`
- Recommended previous task: TASK-M6-006

## 3. In Scope

- Verify auth, refresh, cache, errors, restart, and tab indicators remain independent.
