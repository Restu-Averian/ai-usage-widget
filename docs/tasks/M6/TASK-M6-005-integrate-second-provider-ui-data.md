# TASK-M6-005 — Integrate Second Provider UI and Data
...
Integrate Second Provider UI and Data as a small, independently reviewable step for Second Provider Integration.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M6-second-provider-integration.md`
- Recommended previous task: TASK-M6-004

## 3. In Scope

- Persist, restore, and render provider-specific windows, models, history, source, and cache.
