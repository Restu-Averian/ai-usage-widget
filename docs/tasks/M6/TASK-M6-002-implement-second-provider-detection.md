# TASK-M6-002 — Implement Second Provider Detection
...
Implement Second Provider Detection as a small, independently reviewable step for Second Provider Integration.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M6-second-provider-integration.md`
- Recommended previous task: TASK-M6-001

## 3. In Scope

- Add isolated installation, version, capability, and executable-trust behavior.
