# TASK-M5-002 — Implement Provider CLI Detection
...
Implement Provider CLI Detection as a small, independently reviewable step for First Provider Vertical Slice.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M5-first-provider-vertical-slice.md`
- Recommended previous task: TASK-M5-001

## 3. In Scope

- Resolve executable, version, capabilities, and missing state for selected provider.
