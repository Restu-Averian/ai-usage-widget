# TASK-M5-008 — Persist and Display Provider Usage
...
Persist and Display Provider Usage as a small, independently reviewable step for First Provider Vertical Slice.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M5-first-provider-vertical-slice.md`
- Recommended previous task: TASK-M5-007

## 3. In Scope

- Normalize, transactionally store, emit, query, and render real usage with source and countdown.
