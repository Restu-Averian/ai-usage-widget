# TASK-M5-006 — Implement Real Usage Fetch
...
Implement Real Usage Fetch as a small, independently reviewable step for First Provider Vertical Slice.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M5-first-provider-vertical-slice.md`
- Recommended previous task: TASK-M5-005

## 3. In Scope

- Run approved usage interface with allowlisted arguments, timeout, output cap, and approved TTY or PTY only.
