# TASK-M5-007 — Implement Versioned Provider Parser
...
Implement Versioned Provider Parser as a small, independently reviewable step for First Provider Vertical Slice.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M5-first-provider-vertical-slice.md`
- Recommended previous task: TASK-M5-006

## 3. In Scope

- Parse sanitized fixtures, validate fields, set reliability, and fail closed for unsupported output.
