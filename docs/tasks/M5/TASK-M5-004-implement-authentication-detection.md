# TASK-M5-004 — Implement Authentication Detection
...
Implement Authentication Detection as a small, independently reviewable step for First Provider Vertical Slice.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M5-first-provider-vertical-slice.md`
- Recommended previous task: TASK-M5-003

## 3. In Scope

- Map authenticated, logged-out, expired, and unknown without reading raw credentials.
