# TASK-M11-005 — Write Privacy and Security Summary

**Milestone:** [M11 — Public Beta](../../milestones/M11-public-beta.md)  
**Status:** BACKLOG  
**Priority:** P2  
...
Write Privacy and Security Summary as a small, independently reviewable step for Public Beta.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M11-public-beta.md`
- Recommended previous task: TASK-M11-004

## 3. In Scope

- Describe local data, keyring, no passwords or cookies, logs, updates, and diagnostics accurately.
