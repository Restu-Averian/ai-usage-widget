# TASK-M11-006 — Prepare Feedback Workflow
...
Prepare Feedback Workflow as a small, independently reviewable step for Public Beta.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M11-public-beta.md`
- Recommended previous task: TASK-M11-005

## 3. In Scope

- Collect safe versions, reproduction, provider state, and optional diagnostics without secrets.
