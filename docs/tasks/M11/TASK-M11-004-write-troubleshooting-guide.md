# TASK-M11-004 — Write Troubleshooting Guide
...
Write Troubleshooting Guide as a small, independently reviewable step for Public Beta.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M11-public-beta.md`
- Recommended previous task: TASK-M11-003

## 3. In Scope

- Cover install, auth, refresh, parser, path, secure storage, diagnostics, and safe fallback.
