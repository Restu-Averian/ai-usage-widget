# TASK-M11-002 — Write Installation Guides
...
Write Installation Guides as a small, independently reviewable step for Public Beta.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M11-public-beta.md`
- Recommended previous task: TASK-M11-001

## 3. In Scope

- Document macOS and Windows install, Gatekeeper or SmartScreen, tray, updates, and uninstall.
