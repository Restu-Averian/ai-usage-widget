# TASK-M11-001 — Polish Beta Onboarding
...
Polish Beta Onboarding as a small, independently reviewable step for Public Beta.
...
- Explain product, connection choices, security, supported providers, and skip or return.
