# TASK-M9-003 — Implement Warning and Critical Alerts
...
Implement Warning and Critical Alerts as a small, independently reviewable step for Notifications and History.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M9-notifications-and-history.md`
- Recommended previous task: TASK-M9-002

## 3. In Scope

- Send once when fresh usage crosses configured thresholds per window and period.
