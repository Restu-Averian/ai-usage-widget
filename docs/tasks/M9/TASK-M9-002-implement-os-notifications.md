# TASK-M9-002 — Implement OS Notifications
...
Implement OS Notifications as a small, independently reviewable step for Notifications and History.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M9-notifications-and-history.md`
- Recommended previous task: TASK-M9-001

## 3. In Scope

- Connect safe backend decisions to macOS and Windows notification APIs and click payloads.
