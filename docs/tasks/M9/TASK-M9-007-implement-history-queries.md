# TASK-M9-007 — Implement History Queries
...
Implement History Queries as a small, independently reviewable step for Notifications and History.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M9-notifications-and-history.md`
- Recommended previous task: TASK-M9-006

## 3. In Scope

- Provide indexed seven-day and retention-range queries for provider/window metrics.
