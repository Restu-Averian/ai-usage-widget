# TASK-M12-003 — Define Sync Schema
...
Define Sync Schema as a small, independently reviewable step for Mobile Sync.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M12-mobile-sync.md`
- Recommended previous task: TASK-M12-002

## 3. In Scope

- Create versioned minimal normalized snapshot, freshness, reliability, device, and encryption-envelope schemas.
