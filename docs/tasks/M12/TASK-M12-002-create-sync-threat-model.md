# TASK-M12-002 — Create Sync Threat Model
...
Create Sync Threat Model as a small, independently reviewable step for Mobile Sync.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M12-mobile-sync.md`
- Recommended previous task: TASK-M12-001

## 3. In Scope

- Define accounts, devices, server, snapshots, encryption, revocation, deletion, and metadata threats.
