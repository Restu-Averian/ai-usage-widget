# TASK-M12-007 — Scaffold Mobile App
...
Scaffold Mobile App as a small, independently reviewable step for Mobile Sync.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M12-mobile-sync.md`
- Recommended previous task: TASK-M12-006

## 3. In Scope

- Create Android and iOS shell with auth, overview, providers, history, settings, and cache.
