# TASK-M12-006 — Implement Desktop Sync Client
...
Implement Desktop Sync Client as a small, independently reviewable step for Mobile Sync.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M12-mobile-sync.md`
- Recommended previous task: TASK-M12-005

## 3. In Scope

- Add opt-in upload, device status, retry, backoff, sign out, and no impact on local provider refresh.
