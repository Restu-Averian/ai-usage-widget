# TASK-M12-009 — Implement Native Widgets
...
Implement Native Widgets as a small, independently reviewable step for Mobile Sync.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M12-mobile-sync.md`
- Recommended previous task: TASK-M12-008

## 3. In Scope

- Build iOS WidgetKit and Android Glance or AppWidget summaries with stale labels and deep links.
