# TASK-M10-002 — Configure macOS Signing
...
Configure macOS Signing as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-001

## 3. In Scope

- Configure certificates, minimal entitlements, hardened runtime, and safe CI secret handling.
