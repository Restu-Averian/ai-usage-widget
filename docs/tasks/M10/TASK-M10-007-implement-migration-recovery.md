# TASK-M10-007 — Implement Migration Recovery
...
Implement Migration Recovery as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-006

## 3. In Scope

- Preserve original data on migration failure and provide recoverable UI without silent deletion.
