# TASK-M10-003 — Configure macOS Notarization
...
Configure macOS Notarization as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-002

## 3. In Scope

- Submit, staple, verify Gatekeeper, and test clean installation.
