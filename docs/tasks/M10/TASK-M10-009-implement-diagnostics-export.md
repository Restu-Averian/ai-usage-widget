# TASK-M10-009 — Implement Diagnostics Export
...
Implement Diagnostics Export as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-008

## 3. In Scope

- Export app, OS, CLI versions, states, errors, and sanitized logs with no secrets.
