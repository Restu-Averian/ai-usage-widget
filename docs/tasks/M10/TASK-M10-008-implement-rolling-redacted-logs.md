# TASK-M10-008 — Implement Rolling Redacted Logs
...
Implement Rolling Redacted Logs as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-007

## 3. In Scope

- Add bounded rolling logs, production levels, and secret redaction.
