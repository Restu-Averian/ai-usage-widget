# TASK-M10-005 — Configure Windows Signing
...
Configure Windows Signing as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-004

## 3. In Scope

- Sign binaries and installer with timestamping and safe certificate handling.
