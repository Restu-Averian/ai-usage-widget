# TASK-M10-012 — Create Release Checklist
...
Create Release Checklist as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-011

## 3. In Scope

- Document build, sign, test, publish, update, changelog, rollback, and verification steps.
