# TASK-M10-011 — Run Platform Display Matrix
...
Run Platform Display Matrix as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-010

## 3. In Scope

- Test macOS notch, Spaces, monitors, Windows scaling and taskbars, themes, and high contrast.
