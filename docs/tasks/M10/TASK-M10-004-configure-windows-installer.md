# TASK-M10-004 — Configure Windows Installer
...
Configure Windows Installer as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-003

## 3. In Scope

- Implement install, upgrade, uninstall, shortcuts, autostart cleanup, and app-data policy.
