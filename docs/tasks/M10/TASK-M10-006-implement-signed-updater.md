# TASK-M10-006 — Implement Signed Updater
...
Implement Signed Updater as a small, independently reviewable step for Desktop Hardening.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M10-desktop-hardening.md`
- Recommended previous task: TASK-M10-005

## 3. In Scope

- Add signed manifest, signature verification, channels, UI, and failure recovery.
