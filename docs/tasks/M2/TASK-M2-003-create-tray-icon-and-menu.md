...
Create Tray Icon and Menu as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-002

## 3. In Scope

- Create native tray or Menu Bar icon.
- Add Open/Hide, Refresh All placeholder, Settings, Launch at Login, and Quit.
