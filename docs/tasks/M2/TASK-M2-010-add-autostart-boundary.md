# TASK-M2-010 — Add Autostart Boundary
...
Add Autostart Boundary as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-009

## 3. In Scope

- Integrate official autostart mechanism.
- Expose narrow enable, disable, and query commands.
