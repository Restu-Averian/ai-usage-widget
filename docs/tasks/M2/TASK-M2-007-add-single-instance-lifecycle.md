# TASK-M2-007 — Add Single Instance Lifecycle
...
Add Single Instance Lifecycle as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-006

## 3. In Scope

- Prevent duplicate background instances.
- Route second launch to existing popup.
- Preserve explicit Quit behavior.
