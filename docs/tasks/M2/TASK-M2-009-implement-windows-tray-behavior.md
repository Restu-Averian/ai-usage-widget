# TASK-M2-009 — Implement Windows Tray Behavior
...
Implement Windows Tray Behavior as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-008

## 3. In Scope

- Hide popup from taskbar.
- Add tooltip boundary and taskbar-aware placement.
- Smoke-test display scaling.
