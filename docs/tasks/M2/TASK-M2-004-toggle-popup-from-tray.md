...
Toggle Popup from Tray as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-003

## 3. In Scope

- Show and focus hidden popup.
- Hide visible popup.
- Reuse one existing window and synchronize menu label.
