...
Hide Popup on Focus Loss as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-005

## 3. In Scope

- Hide on outside focus and Escape.
- Add auto-hide guard for dialogs and login flows.
