# TASK-M2-005 — Position Popup Near Tray
...
Position Popup Near Tray as a small, independently reviewable step for Desktop Shell.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M2-desktop-shell.md`
- Recommended previous task: TASK-M2-004

## 3. In Scope

- Resolve active monitor and tray geometry where available.
- Add platform fallback positions.
- Constrain popup to work area.
