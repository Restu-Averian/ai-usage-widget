...
Build Settings UI as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-008

## 3. In Scope

- Implement documented settings sections and reusable rows.
- Add back navigation and platform-specific visibility.
