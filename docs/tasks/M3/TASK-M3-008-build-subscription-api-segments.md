# TASK-M3-008 — Build Subscription and API Segments
...
Build Subscription and API Segments as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-007

## 3. In Scope

- Switch connection views per provider.
- Persist selection per provider.
- Keep metrics and errors separate.
