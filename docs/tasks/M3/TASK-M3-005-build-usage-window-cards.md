# TASK-M3-005 — Build Usage Window Cards
...
Build Usage Window Cards as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-004

## 3. In Scope

- Implement multiple quota cards, progress, model labels, and reset countdown.
- Support unknown values.
- Preserve exact reset detail.
