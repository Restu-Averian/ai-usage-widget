# TASK-M3-006 — Build History Chart
...
Build History Chart as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-005

## 3. In Scope

- Render accessible seven-day history.
- Handle empty, missing-day, reset, and flat states.
