# TASK-M3-012 — Complete UI Accessibility Pass
...
Complete UI Accessibility Pass as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-011

## 3. In Scope

- Verify keyboard, focus, contrast, 125 percent text scaling, 360px width, screen-reader labels, and reduced motion.
