# TASK-M3-010 — Build Connection Details and Dialogs
...
Build Connection Details and Dialogs as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-009

## 3. In Scope

- Implement connection detail, masked API-key dialog, and destructive confirmation.
