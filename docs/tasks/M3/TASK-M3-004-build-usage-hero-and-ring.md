# TASK-M3-004 — Build Usage Hero and Ring
...
Build Usage Hero and Ring as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-003

## 3. In Scope

- Implement percentage, cost, warning, critical, and unknown variants.
- Use accessible SVG.
