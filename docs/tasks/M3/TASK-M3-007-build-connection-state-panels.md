# TASK-M3-007 — Build Connection State Panels
...
Build Connection State Panels as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-006

## 3. In Scope

- Implement disconnected, missing CLI, connecting, auth-expired, error, and unsupported states.
- Drive actions from capabilities.
