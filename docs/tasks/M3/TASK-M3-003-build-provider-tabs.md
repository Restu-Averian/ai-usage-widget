# TASK-M3-003 — Build Provider Tabs
...
Build Provider Tabs as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-002

## 3. In Scope

- Implement Codex, Claude, and Antigravity tabs.
- Add ARIA tab semantics and keyboard navigation.
- Support attention indicators.
