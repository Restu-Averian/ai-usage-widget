# TASK-M3-011 — Implement Mock Provider Scenarios
...
Implement Mock Provider Scenarios as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-010

## 3. In Scope

- Create stable normalized scenarios for all required UI states.
- Support delay, deterministic error, reset, and auth completion.
- Exclude controls from production.
