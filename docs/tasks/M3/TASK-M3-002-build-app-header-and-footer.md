...
Build App Header and Footer as a small, independently reviewable step for Mock UI.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M3-mock-ui.md`
- Recommended previous task: TASK-M3-001

## 3. In Scope

- Implement app title, refresh, settings, freshness, and status surfaces.
- Keep layout stable during refresh.
