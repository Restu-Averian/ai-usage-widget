# TASK-M7-005 — Complete Provider Capability Matrix
...
Complete Provider Capability Matrix as a small, independently reviewable step for Third Provider or Safe Fallback.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M7-third-provider-or-fallback.md`
- Recommended previous task: TASK-M7-004

## 3. In Scope

- Document automatic or fallback, API support, TTY, multiple windows/models, and versions for all providers.
