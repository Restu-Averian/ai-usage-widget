# TASK-M7-002 — Implement Third Provider Detection
...
Implement Third Provider Detection as a small, independently reviewable step for Third Provider or Safe Fallback.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M7-third-provider-or-fallback.md`
- Recommended previous task: TASK-M7-001

## 3. In Scope

- Add installation, version, capability, trust, unsupported, and dashboard states.
