# TASK-M7-006 — Run Three-Provider Regression
...
Run Three-Provider Regression as a small, independently reviewable step for Third Provider or Safe Fallback.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M7-third-provider-or-fallback.md`
- Recommended previous task: TASK-M7-005

## 3. In Scope

- Test Refresh All, partial success, offline, auth expiry, unsupported version, restart, and tray summary.
