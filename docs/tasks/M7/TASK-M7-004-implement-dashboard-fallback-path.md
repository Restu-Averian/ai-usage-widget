# TASK-M7-004 — Implement Dashboard Fallback Path

**Milestone:** [M7 — Third Provider or Safe Fallback](../../milestones/M7-third-provider-or-fallback.md)  
**Status:** BACKLOG  
**Priority:** P2  
...
Implement Dashboard Fallback Path as a small, independently reviewable step for Third Provider or Safe Fallback.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M7-third-provider-or-fallback.md`
- Recommended previous task: TASK-M7-003

## 3. In Scope

- Explain limitation, open official dashboard, support recheck, and show version detail without unsafe workarounds.
