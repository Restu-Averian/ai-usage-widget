# TASK-M7-003 — Implement Third Provider Automatic Path
...
Implement Third Provider Automatic Path as a small, independently reviewable step for Third Provider or Safe Fallback.

## 2. Dependencies

- Milestone prerequisites from `../../milestones/M7-third-provider-or-fallback.md`
- Recommended previous task: TASK-M7-002

## 3. In Scope

- When approved, add auth, fetch, parser, persistence, UI, cache, errors, and tests to M5 quality.
